...
const services = [
  {
    ...
    title: "WEB DESIGNING",
    description:
      "Creative, user-friendly designs that enhance your brand’s online presence Lorem ipsum dolor sit amet...",
  ...
  },
  {
    ...
    description:
      "Boost your website visibility, traffic, and ranking on Google...",
  ...
  },
  {
    ...
    description:
      "Maximize your reach and ROI with high-performing ads across Google and Meta...",
...
export const ServicesSection = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) return; // ✅ MOBILE FIX — disable ScrollTrigger
  ...
  return (
    <section ref={sectionRef} className="bg-background font-playfair antialiased">
